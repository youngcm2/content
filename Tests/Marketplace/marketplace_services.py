            ...
            for root, pack_dirs, pack_files_names in os.walk(self._pack_path, topdown=False):
                ...
                for pack_file_name in pack_files_names:
                    ...
                    if to_version and LooseVersion(to_version) < LooseVersion(Metadata.SERVER_DEFAULT_MIN_VERSION):
                        os.remove(pack_file_path)
                        logging.info(f"{self._pack_name} pack content item {pack_file_name} has to version: {to_version}. "
                    ...
                    logging.info(f"Iterating over {pack_file_path} file and collecting items of {self._pack_name} pack")
